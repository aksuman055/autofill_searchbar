...
export class PersonsCard extends React.Component<PersonsProps, State> {
  ...
  render(): React.ReactNode {
    ...
    return (
      ...
      >
        <div className="line id">{this.highLightText(data.name)}</div>
        <div className="line name">{this.highLightText(data.designation)}</div>

        <div className="line address">{this.highLightText(data.address)}</div>
        <div className="line name">Salary: {this.highLightText(data.salary)}</div>
        {/* {this.getItems()} */}
